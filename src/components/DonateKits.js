...
const DonateKits = () => {
    ...
    const donationsRef = ref(database, 'iot-kit-donations');
    ...
    return (
        <div className="donation-container" id='initiative/3.4'>
            <h1>Donate IoT Kits</h1>
            <p>Your donation will help us monitor turtles and oceans. Thank you for your generosity!</p>
            ...
            <h1>IoT Kits donations made so far..</h1>
